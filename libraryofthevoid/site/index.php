      ...
      <div id="main_content_wrapper">
        ...
        <div id="content">
          <div id="content_picture">
            <img src="styles/cyberpunk.jpg" alt="">
          </div>
          <div id="content_text">
            You made it.
            <br>
            <br>
            <?php
              echo 'Welcome <font color="#66cd00">['.$_SERVER['REMOTE_ADDR'].']</font> !<br>';
             ?>
             <br>
            Grab yourself some soycaf and make y0urself at home.
            <br>
            <br>
            <font color="#66cd00">There has never been a documented human fatality solely from overdosing on tetrahydrocannabinol. </font><br>
            <br>
            <br>
            P.s? <font color="#F7FE2E">THE GOLDEN ERA IS DEAD.</font>
            <br>
             :: <font color="#F7FE2E">Unified by knowledge, divided by 0</font> ::
            <br>
            <br>
            <div id="metadata-content-wrapper">
              |13/37/2017|  by : echo731
